...
export function WorkspaceComposer() {
  ...
  return (
    <>
      ...
      <dialog ref={dialogRef} onCancel={(event) => { event.preventDefault(); setOpen(false); }} onClose={() => setOpen(false)} aria-labelledby="workspace-composer-title" className="m-auto w-full max-w-md rounded-card border border-border bg-paper p-0 text-ink backdrop:bg-ink/30">
