...
export function WorkspaceNavGroup({
  ...
  return (
    <div
      className={`relative mx-2 flex h-9 items-center rounded-lg transition-colors motion-reduce:transition-none ${
        active
    ...
    >
      ...
      <button
        ...
        onClick={onToggle}
        className="flex size-9 shrink-0 items-center justify-center rounded-lg outline-none focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-ink"
      >
        <Icon
          name="chevron-down"
      ...
      <Link
        ...
        className="flex min-w-0 flex-1 items-center gap-3 py-2 pr-3 text-small font-medium outline-none focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-ink"
      >
