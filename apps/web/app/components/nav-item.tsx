...
export function NavItem({
  ...
  return (
    <Link
      ...
      className={`relative flex h-9 items-center rounded-lg text-small font-medium outline-none transition-colors focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-ink motion-reduce:transition-none ${
